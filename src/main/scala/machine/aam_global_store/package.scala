...
package object aam_global_store {
  ...
  type FullState[Exp, Abs, Addr, Time] = (KickstartAAMState[Exp, Abs, Addr, Time], GlobalStore[Addr, Abs], KontStore[KontAddr])

  type Tup[Exp, Abs, Addr, Time] = (EdgeAnnotation[Exp, Abs, Addr], KickstartAAMState[Exp, Abs, Addr, Time])
  type G[Exp, Abs, Addr, Time] = Graph[KickstartAAMState[Exp, Abs, Addr, Time], EdgeAnnotation[Exp, Abs, Addr], KickstartAAMState.Context[Exp, Abs, Addr, Time]]
  ...
  implicit def stateWithKey[Exp: Expression, Abs: JoinLattice, Addr: Address, Time: Timestamp] = new WithKey[KickstartAAMState[Exp, Abs, Addr, Time]] {
    type K = KontAddr
