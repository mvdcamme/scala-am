...
case class AmbProgramState[AbstL : IsConvertableLattice, Exp : Expression]
(normalState: ProgramState[AbstL, Exp],
 failStack: List[Frame])
  ...
  def this(normalState: ProgramState[AbstL, Exp]) = this(normalState, List(HaltFailFrame()))
  ...
  def wrapApplyAction(sem: SemanticsTraced[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T],
    ...
    ActionReturn[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]] = normalState.applyAction(sem, action) match {
    case ActionStep(state, action) =>
      ActionStep(AmbProgramState(state, failStack), action)
    case GuardFailed(rp, guardID) => GuardFailed[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]](rp, guardID)
    case TraceEnded(rp) => TraceEnded[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]](rp)
  }
  ...
  ActionReturn[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]] = {
  ...
  ActionReturn[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]] = {
    val step: ActionReturn[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, ProgramState[AbstL, Exp]] = normalState.applyAction(sem, action)
    step match {
      case ActionStep(state, action) =>
  ...
  def convertState(free: Free[Exp, HybridLattice[AbstL]#L, HybridAddress.A, HybridTimestamp.T])
  ...
  def runHeader(sem: SemanticsTraced[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T],
                assertions: List[ActionT[Exp, HybridValue, HybridAddress.A]]): Option[AmbProgramState[AbstL, Exp]] =
    normalState.runHeader(sem, assertions).fold(None: Option[AmbProgramState[AbstL, Exp]])(programState => Some(AmbProgramState(programState, failStack)))

  def restart(sem: SemanticsTraced[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T],
              restartPoint: RestartPoint[Exp, HybridValue, HybridAddress.A]): AmbProgramState[AbstL, Exp] = restartPoint match {
  ...
  def applyAction(sem: SemanticsTraced[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T],
                  action: ActionT[Exp, HybridValue, HybridAddress.A]):
  ActionReturn[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T, AmbProgramState[AbstL, Exp]] = action match {
  ...
  def subsumes(that: TracingProgramState[Exp, HybridValue, HybridAddress.A, HybridTimestamp.T]): Boolean = that match {
    case that: AmbProgramState[AbstL, Exp] =>
