...
case class RestartStoppedInBacktrack[
...
case class ActionSinglePushKontT[Exp: Expression, Abs: JoinLattice,
Addr: Address](frame: Frame)
    extends ActionSingleT[Exp, Abs, Addr]
    with PushesKStack[Exp, Abs, Addr]
case class ActionSingleSaveSpecificEnvT[Exp: Expression,
                                        Abs: JoinLattice,
                                        Addr: Address](
    ρToSave: Environment[Addr],
    ρToReplace: Environment[Addr])
    extends ActionSingleT[Exp, Abs, Addr]
    with SavesEnv[Exp, Abs, Addr]
case class ActionSingleSaveValT[Exp: Expression, Abs: JoinLattice,
Addr: Address](value: Abs)
    extends ActionSingleT[Exp, Abs, Addr]
    with PushesValue[Exp, Abs, Addr]
case class ActionSingleRestoreEnvT[
    Exp: Expression, Abs: JoinLattice, Addr: Address]()
    extends ActionSingleT[Exp, Abs, Addr]
    with RestoresEnv[Exp, Abs, Addr]
case class ActionSingleRestoreValT[
    Exp: Expression, Abs: JoinLattice, Addr: Address]()
    extends ActionSingleT[Exp, Abs, Addr]
