...
abstract class Tests[Exp: Expression, Addr: Address, Time: Timestamp](
  ...
  r5rs("real?",
       Table(("program", "answer"), ("(real? 3)", t), ("(real? 1.5)", t)))
...
abstract class AAMPrimitiveTests[Addr: Address, Time: Timestamp](
...
abstract class AAMGlobalStorePrimitiveTests[Addr: Address, Time: Timestamp](
    override val lattice: SchemeLattice)
    extends Tests[SchemeExp, Addr, Time](lattice) {
  val sem = new SchemeSemantics[lattice.L, Addr, Time](
    new SchemePrimitives[Addr, lattice.L])
...
abstract class AACPrimitiveTests[Addr: Address, Time: Timestamp](
    override val lattice: SchemeLattice)
    extends Tests[SchemeExp, Addr, Time](lattice) {
  val sem = new SchemeSemantics[lattice.L, Addr, Time](
    new SchemePrimitives[Addr, lattice.L])
...
abstract class FreePrimitiveTests[Addr: Address, Time: Timestamp](
    override val lattice: SchemeLattice)
    extends Tests[SchemeExp, Addr, Time](lattice) {
  val sem = new SchemeSemantics[lattice.L, Addr, Time](
    new SchemePrimitives[Addr, lattice.L])
...
abstract class ConcreteMachinePrimitiveTests(
    override val lattice: SchemeLattice)
...
class AAMConcretePrimitiveTests
    extends AAMPrimitiveTests[ClassicalAddress.A, ConcreteTimestamp.T](
      new ConcreteLattice(true))
class AAMTypeSetPrimitiveTests
    extends AAMPrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new TypeSetLattice(false))
class AAMBoundedIntPrimitiveTests
    extends AAMPrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new BoundedIntLattice(100, false))
class AAMGlobalStoreConcretePrimitiveTests
    extends AAMGlobalStorePrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new ConcreteLattice(true))
class AAMGlobalStoreTypeSetPrimitiveTests
    extends AAMGlobalStorePrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new TypeSetLattice(false))
class AAMGlobalStoreBoundedIntPrimitiveTests
    extends AAMGlobalStorePrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new BoundedIntLattice(100, false))
class AACConcretePrimitiveTests
    extends AACPrimitiveTests[ClassicalAddress.A, ConcreteTimestamp.T](
      new ConcreteLattice(true))
class AACTypeSetPrimitiveTests
    extends AACPrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new TypeSetLattice(false))
class AACBoundedIntPrimitiveTests
    extends AACPrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new BoundedIntLattice(100, false))
class FreeConcretePrimitiveTests
    extends FreePrimitiveTests[ClassicalAddress.A, ConcreteTimestamp.T](
      new ConcreteLattice(true))
class FreeTypeSetPrimitiveTests
    extends FreePrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new TypeSetLattice(false))
class FreeBoundedIntPrimitiveTests
    extends FreePrimitiveTests[ClassicalAddress.A, ZeroCFA.T](
      new BoundedIntLattice(100, false))
class ConcreteMachineConcretePrimitiveTests
    extends ConcreteMachinePrimitiveTests(new ConcreteLattice(true))
